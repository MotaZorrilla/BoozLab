...
export function AppSidebar() {
    ...
    const pageProps = usePage().props as unknown as AdminPageProps;

    const currentUserRole = pageProps.auth?.user?.role || 'super_admin';
    const isSuperAdmin =
        currentUserRole === 'super_admin' || !!pageProps.auth?.user?.is_admin;
            ...
            },
            {
                ...
                items: [
                    ...
                    },
                    {
                        ...
                        icon: MessageSquare,
                        badge:
                            pendingMessages > 0 ? pendingMessages : undefined,
                ...
                {navigationGroups.map((group) => {
                    ...
                    return (
                        <SidebarGroup key={group.label} className="px-2 py-1">
                            <SidebarGroupLabel className="text-[10px] font-bold tracking-wider text-slate-400 uppercase dark:text-slate-500">
                                {group.label}
                            </SidebarGroupLabel>
                            <SidebarGroupContent>
                                <SidebarMenu>
                                        ...
                                        return (
                                            <SidebarMenuItem key={item.title}>
                                                <SidebarMenuButton
                                                    ...
                                                    className={
                                                        active
                                                            ? 'bg-[#002072] text-white hover:bg-[#00154D] dark:bg-blue-600 dark:hover:bg-blue-500'
                                                            : ''
                                                    }
                                                >
                                                    <Link
                                                    ...
                                                    <SidebarMenuBadge
                                                        className={
                                                            ...
                                                            'amber'
                                                                ...
                                                                : 'animate-pulse bg-rose-500 font-bold text-white'
                                                        }
                                                    >
                                                        {item.badge}
                                                    </SidebarMenuBadge>
